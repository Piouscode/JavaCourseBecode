...
public class $8_ClassesYousraSolution {

private final Map<LocalDate, Map<String, Integer>> data;

public $8_ClassesYousraSolution() {
	data = new HashMap<>();
}

public static void main(String[] args) throws IOException {
	$8_ClassesYousraSolution hospitalData = new $8_ClassesYousraSolution();
	hospitalData.loadData("src/$8_ClassesYousraSolution.csv");
	hospitalData.reportPerDay(LocalDate.of(2021, 7, 27), "src/$8_Classes_report-2021-07-27.csv");
	hospitalData.reportPerMonth(2021, 7, "src/$8_Classes_report-2021-07.csv");
}
